namespace Cboe.Bzx.Equities.OrderEntry.Boe.v2.3 {
    ...
    public enum SubLiquidityIndicator : byte {
        ...
        ExecutionFromFirstOrderThatSetTheNbbo = (byte)'S',
        VisisbleLiquidityAddTradeThatWasPriceImproved = (byte)'V',
